...
#define cpu_map_h
  ...
  //TODO:  Define stepper driver enable/disable output pin.
  #define STEPPERS_DISABLE_DDR    DDRC
  #define STEPPERS_DISABLE_PORT   PORTC
  #define STEPPERS_DISABLE_BIT    7  // Uno Analog Pin 7
...
//  #ifdef VARIABLE_SPINDLE // Z Limit pin and spindle enabled swapped to access hardware PWM on Pin 11.
    #define Z_LIMIT_BIT	   0 // Uno Digital Pin 8
//  #else
...
//    #define SPINDLE_PWM_BIT   3    // Uno Digital Pin 11
  ...
  // the spindle direction and optional coolant mist pins.
       ...
       #define DUAL_DIRECTION_BIT  6  // Uno Analog Pin 6
...
//       #endif
       ...
       #define SPINDLE_PWM_BIT   3    // Uno Digital Pin 11
        ...
        // TODO: make sure these dont overlap
       #define PROBE_CONTROL1_DDR   DDRC
       #define PROBE_CONTROL1_PORT  PORTC
       #define PROBE_CONTROL1_BIT   3  // Uno Analog Pin 3
       #define PROBE_CONTROL1_MASK  (1<<PROBE_CONTROL1_BIT)
       #define PROBE_CONTROL2_DDR   DDRC
       #define PROBE_CONTROL2_PORT  PORTC
       #define PROBE_CONTROL2_BIT   5  // Uno Analog Pin 5
       #define PROBE_CONTROL2_MASK  (1<<PROBE_CONTROL2_BIT)

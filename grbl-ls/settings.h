...
// Define bit flag masks for the boolean settings in settings.extended_flags.
#define EXT_BIT_DRY_RUN        0

#define EXT_BITFLAG_DRY_RUN        bit(EXT_BIT_DRY_RUN)
...
typedef struct {
  ...
  uint8_t extended_flags; // Contains more boolean settings

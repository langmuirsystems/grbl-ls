...
typedef struct {
  ...
  #if defined(ENABLE_DUAL_AXIS) && !defined(DUAL_AXIS_SHARED_DIRECTION)
...
{
  if (sys.state & (STATE_CYCLE | STATE_HOMING | STATE_HOLD | STATE_JOG | STATE_WAIT_THC)){

...
#define cpu_map_h
  ...
  #define STEP_MASK_THC      ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)) // All step bits minus Z
  ...
  #define DIRECTION_MASK_THC    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)) // All direction bits minus Z
  ...
  #define CONTROL_CYCLE_START_BIT   5  // Uno Analog Pin 5
  #define CONTROL_INT       PCIE1  // Pin change interrupt enable pin
  #define CONTROL_INT_vect  PCINT1_vect
  #define CONTROL_PCMSK     PCMSK1 // Pin change interrupt register
  #define CONTROL_MASK      (1<<CONTROL_FEED_HOLD_BIT)
  ...
  #define PROBE_BIT       2  // Uno Analog Pin 2
  #define PROBE_MASK      (1<<PROBE_BIT)
    ...
    // the spindle direction and optional coolant mist pins.
      ...
      #ifndef DUAL_AXIS_SHARED_DIRECTION
    ...
    // Note: Variable spindle and coolant not supported with this shield.
    #ifdef DUAL_AXIS_CONFIG_CROSSFIRE_XR
      // NOTE: Step pulse and direction pins may be on any port and output pin.
      #define STEP_DDR_DUAL       DDRC
      #define STEP_PORT_DUAL      PORTC
      #define DUAL_STEP_BIT       4  // Uno Analog Pin 4
  ...
  #define THC_ENABLE_DDR    DDRC
  #define THC_ENABLE_PORT   PORTC
  #define THC_ENABLE_BIT    5  // Uno Digital Pin 19
  #define THC_ENABLE_MASK   (1<<THC_ENABLE_BIT)

  #define THC_WAIT_DDR      DDRC
  #define THC_WAIT_PORT     PORTC
  #define THC_WAIT_PIN      PINC
  #define THC_WAIT_BIT      3  // Uno Analog Pin 3
  #define THC_WAIT_MASK     (1<<THC_WAIT_BIT)

  #define STATUS_LED1_DDR   DDRC
  #define STATUS_LED1_PORT  PORTC
  #define STATUS_LED1_BIT   0  // Uno Analog Pin 0
  #define STATUS_LED1_MASK  (1<<STATUS_LED1_BIT)
  #define STATUS_LED2_DDR   DDRB
  #define STATUS_LED2_PORT  PORTB
  #define STATUS_LED2_BIT   5  // Uno Digital Pin 13
  #define STATUS_LED2_MASK  (1<<STATUS_LED2_BIT)
  #define STATUS_LED3_DDR   DDRB
  #define STATUS_LED3_PORT  PORTB
  #define STATUS_LED3_BIT   0  // Uno Digital Pin 8
  #define STATUS_LED3_MASK  (1<<STATUS_LED3_BIT)

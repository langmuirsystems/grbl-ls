...
void mc_dwell(float seconds)
{
  ...
  // Adjust for dwell time override here, instead of in the g-code interpreter. This is
  // because the override setting might have changed between parsing the dwell command and
  // waiting for protocol_buffer_synchronize() to return.
  delay_sec(seconds*0.01*sys.d_override, DELAY_MODE_DWELL);
}

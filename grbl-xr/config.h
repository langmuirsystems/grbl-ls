...
#define CMD_DWELL_OVR_RESET 0xA2
#define CMD_DWELL_OVR_COARSE_PLUS 0xA3
#define CMD_DWELL_OVR_COARSE_MINUS 0xA4
#define CMD_DWELL_OVR_FINE_PLUS 0xA5
#define CMD_DWELL_OVR_FINE_MINUS 0xA6

// DRY RUN CMD
#define CMD_DRY_RUN_TOGGLE 0xA7

// Force enter THC wait state
#define CMD_WAIT_THC 0xA8
// Force exit THC wait state
#define CMD_CANCEL_WAIT_THC 0xA9
...
// #define INVERT_CONTROL_PIN_MASK ((1<<CONTROL_FEED_HOLD_BIT)) // control feed hold bit inverted
...
#define DEFAULT_DWELL_TIME_OVERRIDE     100 // 100%. Don't change this value.
#define MAX_DWELL_TIME_OVERRIDE        1000 // Percent of programmed dwell time (100-65535). Usually 1000%.
#define MIN_DWELL_TIME_OVERRIDE          10 // Percent of programmed dwell time (1-100). Usually 10%.
#define DWELL_OVERRIDE_COARSE_INCREMENT  10 // (1-99). Usually 10%.
#define DWELL_OVERRIDE_FINE_INCREMENT     1 // (1-99). Usually 1%.
...
// Whether the direction pin for the dual axis motors is shared between both motors
#define DUAL_AXIS_SHARED_DIRECTION  // Default disabled. Uncomment to enable.
...
#define DUAL_AXIS_HOMING_FAIL_DISTANCE_MAX  50.0  // Float (mm)
...
#define DUAL_AXIS_CONFIG_CROSSFIRE_XR
